var InfoObject = {
    ...
    savePan: function () {
        ...
        if (url) {
            ...
            common.showHint("warning", "获取网盘链接失败");
        }
    },
    contact: function () {
            ...
            $.ajax({
                ...
                success : function(res) {//返回数据根据结果进行相应的处理
                    ...
                    if (res.code == 200) {
                        ...
                        var url = res.data.BaiduUrl + "?pwd=" + res.data.BaiduPassword;
                        if (url) {
                            document.getElementById("copyData").setAttribute("locationUrl", url);
                        }
                        return;
                    }
                    window.scrollTo(0, 0);
